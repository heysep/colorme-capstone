...
@Entity({
  name: 'rn_tenant_cbiz_sales_prd_manufacture_history',
  comment: '판매 제품 제조 이력 테이블',
  engine: 'InnoDB',
})
export class RnTenantCbizSalesProductManufactureHistoryEntity extends RnBaseBaseMysqlEntity {
  @PrimaryColumn({
    type: 'varchar',
    length: 50,
    comment: '판매 제품 제조 이력 고유 아이디',
    example: '판매 제품 제조 이력 고유 아이디',
    generated: 'uuid',
    nullable: false,
  })
  id: string;
